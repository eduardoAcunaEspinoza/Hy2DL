...
class Feng2022(BaseLoss):
    """Balanced flow root-mean-squared-error.

    This loss uses both the discharge and the logarithm of the discharge. The second part aims at improving low flows
    representation. A description of this function is available at [#]_.
