...
<p align="justify">
Hy<sup>2</sup>DL is a python library to create hydrological models for rainfall-runoff prediction using deep learning methods. Besides the main code, the repository provides examples in the main Large-Sample-Hydrology datasets (e.g. CAMELS_GB, CAMELS_US, CAMELS_DE, ...) that are easy to understand, interpret and implement. In addition to Long Short Term Memory (LSTM) network architectures, the repository also features hybrid hydrological models, and a transformer architecture.
