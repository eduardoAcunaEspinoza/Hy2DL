...
if __name__ == "__main__":
    ...
    path_experiment_settings = "../examples/configs/hybrid_camels_us.yml"
    ...
    config.unique_prediction_blocks = True
    ...
    # When we run our testing period we do a single rollout through all the period. To do that, we need to update the
    # sequence length and the number of steps to predict (predict_last_n) according to the length of the testing period.
    config.unique_prediction_blocks = False
